...
public class SegundoFragment extends Fragment implements View.OnClickListener {
    ...
    // Crear método onViewCreate

    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        nombre = view.findViewById(R.id.idTVNombreFragmentSegundo);
        apellidos = view.findViewById(R.id.idTVApellidosFragmentSegundo);
        telefono = view.findViewById(R.id.idTVTelefonoFragmentSegundo);
